...
public class BubblesService extends Service {
    ...
    private List<com.binh.mylibrary.BubbleLayout> bubbles = new ArrayList<>();
    private com.binh.mylibrary.BubbleTrashLayout bubblesTrash;
    ...
    public boolean onUnbind(Intent intent) {
        for (com.binh.mylibrary.BubbleLayout bubble : bubbles) {
    ...
    private void recycleBubble(final com.binh.mylibrary.BubbleLayout bubble) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                getWindowManager().removeView(bubble);
                for (com.binh.mylibrary.BubbleLayout cachedBubble : bubbles) {
    ...
    public void addBubble(com.binh.mylibrary.BubbleLayout bubble, int x, int y) {
    ...
    public void removeBubble(com.binh.mylibrary.BubbleLayout bubble) {
        recycleBubble(bubble);
    }
