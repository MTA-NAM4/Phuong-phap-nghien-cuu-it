...
final class BubblesLayoutCoordinator {
    ...
    private com.binh.mylibrary.BubblesService bubblesService;
    ...
    public void notifyBubblePositionChanged(com.binh.mylibrary.BubbleLayout bubble, int x, int y) {
        if (trashView != null) {
    ...
    private void applyTrashMagnetismToBubble(com.binh.mylibrary.BubbleLayout bubble) {
    ...
    private boolean checkIfBubbleIsOverTrash(com.binh.mylibrary.BubbleLayout bubble) {
    ...
    public void notifyBubbleRelease(com.binh.mylibrary.BubbleLayout bubble) {
        if (trashView != null) {
            if (checkIfBubbleIsOverTrash(bubble)) {
    ...
    public static class Builder {
        ...
        public Builder(com.binh.mylibrary.BubblesService service) {
